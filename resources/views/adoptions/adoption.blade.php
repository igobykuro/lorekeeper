                    ...
                    <div class="card p-3">
                        ...
                        <div class="text-center inventory-character" data-id="{{ $stock->character->id }}">
                            ...
                            <a href="#" class="btn btn-primary m-2">
                                @if ($stock->use_character_bank == 1)
                                    <i class="fas fa-paw mr-1" data-toggle="tooltip" title="Can be purchased using Character Bank"></i>
                                @endif
                                <strong>Purchase</strong>
                                @if ($stock->use_user_bank == 1)
                                    <i class="fas fa-user ml-1" data-toggle="tooltip" title="Can be purchased using User Bank"></i>
                                @endif
                            </a>
                        </div>
                    </div>
