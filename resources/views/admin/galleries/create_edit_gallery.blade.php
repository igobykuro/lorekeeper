...
@section('admin-content')
    ...
    <h3 class="mt-5">
        Criteria Rewards
        <button class="btn btn-primary float-right add-calc" type="button" aria-label="add criterion">+ Criterion</a>
    </h3>
    <p>
        ...
        @foreach ($gallery->criteria as $criterion)
            <div class="card p-3 mb-2 pl-0">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div>
                        <button class="btn btn-danger delete-calc" type="button" aria-label="delete criterion"><i class="fas fa-trash"></i></button>
                    </div>
                </div>
