...
<h2>Comments</h2>
<div class="card mb-3">
    <div class="card-body">{!! nl2br(htmlentities($surrender->notes)) !!}</div>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-2 mb-md-0 mb-2">
                <a href="{{ $surrender->character->url }}">
                    <h3 class="text-uppercase">{!! $surrender->character->displayname !!}</h3>
                </a>
            ...
            <div class="col-md-6 mb-md-0 mb-2">
                ...
                {{ $surrender->worth }} @if ($surrender->worth)
                    {{ $worth->name }}
                @endif
            </div>
        </div>
